...
/* Include files */
#include "_coder_CBF_Lfs1_api.h"
#include "_coder_CBF_Lfs1_mex.h"
...
void CBF_Lfs1_api(const mxArray * const prhs[7], int32_T nlhs, const mxArray
                  *plhs[1])
{
  real_T (*in1)[10];
  real_T (*in2)[5];
  ...
  ldes = CBF_Lfs1(*in1, *in2, *in3, ldes, r, m1, a);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(ldes);
}

void CBF_Lfs1_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  CBF_Lfs1_xil_terminate();
  CBF_Lfs1_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}

void CBF_Lfs1_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_CBF_Lfs1_api.c) */
