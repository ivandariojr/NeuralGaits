...
/* Include files */
#include "_coder_CBF_LgLfs2_api.h"
#include "_coder_CBF_LgLfs2_mex.h"
...
void CBF_LgLfs2_api(const mxArray * const prhs[7], int32_T nlhs, const mxArray
                    *plhs[1])
{
  real_T (*LgLfs2)[4];
  real_T (*in1)[10];
  ...
  LgLfs2 = (real_T (*)[4])mxMalloc(sizeof(real_T [4]));
  ...
  CBF_LgLfs2(*in1, *in2, *in3, ldes, r, m1, a, *LgLfs2);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(*LgLfs2);
}

void CBF_LgLfs2_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  CBF_LgLfs2_xil_terminate();
  CBF_LgLfs2_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}

void CBF_LgLfs2_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
void CBF_LgLfs2_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_CBF_LgLfs2_api.c) */
