...
/* Include files */
#include "main.h"
#include "CBF_LgLfs2.h"
#include "CBF_LgLfs2_terminate.h"
...
static void main_CBF_LgLfs2(void);
...
static void main_CBF_LgLfs2(void)
{
  ...
  /* Initialize function 'CBF_LgLfs2' input arguments. */
  ...
  /* Call the entry-point 'CBF_LgLfs2'. */
  argInit_10x1_real_T(dv);
  argInit_1x5_real_T(dv1);
  argInit_1x2_real_T(dv2);
  CBF_LgLfs2(dv, dv1, dv2, ldes_tmp, ldes_tmp, ldes_tmp, ldes_tmp, LgLfs2);
}
