...
#include "CBF_ds2edx_terminate.h"
...
static void main_CBF_ds2edx(void);
...
static void main_CBF_ds2edx(void)
{
  ...
  /* Initialize function 'CBF_ds2edx' input arguments. */
  ...
  /* Call the entry-point 'CBF_ds2edx'. */
  argInit_10x1_real_T(dv);
  argInit_1x5_real_T(dv1);
  argInit_1x2_real_T(dv2);
  CBF_ds2edx(dv, dv1, dv2, ldes_tmp, ldes_tmp, ldes_tmp, ldes_tmp, ds2edx);
}
