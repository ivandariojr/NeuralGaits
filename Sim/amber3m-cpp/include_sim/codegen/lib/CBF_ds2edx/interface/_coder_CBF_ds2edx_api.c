...
/* Include files */
#include "_coder_CBF_ds2edx_api.h"
#include "_coder_CBF_ds2edx_mex.h"
...
void CBF_ds2edx_api(const mxArray * const prhs[7], int32_T nlhs, const mxArray
                    *plhs[1])
{
  real_T (*ds2edx)[10];
  real_T (*in1)[10];
  ...
  ds2edx = (real_T (*)[10])mxMalloc(sizeof(real_T [10]));
  ...
  CBF_ds2edx(*in1, *in2, *in3, ldes, r, m1, a, *ds2edx);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(*ds2edx);
}

void CBF_ds2edx_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  CBF_ds2edx_xil_terminate();
  CBF_ds2edx_xil_shutdown();
...
void CBF_ds2edx_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_CBF_ds2edx_api.c) */
