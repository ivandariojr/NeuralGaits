...
void LgLf_psw_lb_api(const mxArray *const prhs[5], const mxArray **plhs)
{
  ...
  b_LgLf_psw_lb = (real_T(*)[4])mxMalloc(sizeof(real_T[4]));
  ...
  LgLf_psw_lb(*in1, h, k, r, lb, *b_LgLf_psw_lb);
  /* Marshall function outputs */
  *plhs = emlrt_marshallOut(*b_LgLf_psw_lb);
}
...
void LgLf_psw_lb_atexit(void)
{
  ...
  LgLf_psw_lb_xil_terminate();
  LgLf_psw_lb_xil_shutdown();
...
/* End of code generation (_coder_LgLf_psw_lb_api.c) */
