...
/* Include files */
#include "_coder_CBF_LgLfs1_api.h"
#include "_coder_CBF_LgLfs1_mex.h"
...
void CBF_LgLfs1_api(const mxArray * const prhs[7], int32_T nlhs, const mxArray
                    *plhs[1])
{
  real_T (*LgLfs1)[4];
  real_T (*in1)[10];
  ...
  LgLfs1 = (real_T (*)[4])mxMalloc(sizeof(real_T [4]));
  ...
  CBF_LgLfs1(*in1, *in2, *in3, ldes, r, m1, a, *LgLfs1);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(*LgLfs1);
}

void CBF_LgLfs1_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  CBF_LgLfs1_xil_terminate();
  CBF_LgLfs1_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}

void CBF_LgLfs1_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
void CBF_LgLfs1_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_CBF_LgLfs1_api.c) */
