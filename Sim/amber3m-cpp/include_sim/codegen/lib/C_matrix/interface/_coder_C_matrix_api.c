...
void C_matrix_api(const mxArray * const prhs[2], int32_T nlhs, const mxArray
                  *plhs[1])
{
  real_T (*C)[25];
  real_T (*in1)[5];
  ...
  C = (real_T (*)[25])mxMalloc(sizeof(real_T [25]));
...
void C_matrix_atexit(void)
{
  ...
  C_matrix_xil_terminate();
  C_matrix_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}

void C_matrix_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_C_matrix_api.c) */
