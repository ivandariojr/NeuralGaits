...
static void main_CBF_Lf2s1(void);
...
static void main_CBF_Lf2s1(void)
{
  ...
  /* Initialize function 'CBF_Lf2s1' input arguments. */
  ...
  /* Call the entry-point 'CBF_Lf2s1'. */
  argInit_10x1_real_T(dv);
  argInit_1x5_real_T(dv1);
  argInit_1x2_real_T(dv2);
  ldes_tmp = CBF_Lf2s1(dv, dv1, dv2, ldes_tmp, ldes_tmp, ldes_tmp, ldes_tmp);
}
