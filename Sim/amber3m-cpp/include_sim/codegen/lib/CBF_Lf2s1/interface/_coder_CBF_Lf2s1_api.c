...
void CBF_Lf2s1_api(const mxArray * const prhs[7], int32_T nlhs, const mxArray
                   *plhs[1])
{
  real_T (*in1)[10];
  real_T (*in2)[5];
  ...
  ldes = CBF_Lf2s1(*in1, *in2, *in3, ldes, r, m1, a);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(ldes);
}

void CBF_Lf2s1_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  CBF_Lf2s1_xil_terminate();
  CBF_Lf2s1_xil_shutdown();
...
/* End of code generation (_coder_CBF_Lf2s1_api.c) */
