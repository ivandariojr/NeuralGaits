  ...
  const emlrtMsgIdentifier *msgId))[20]
{
  ...
  void Lf2y_matrix_api(const mxArray * const prhs[4], int32_T nlhs, const
  mxArray *plhs[1])
{
  real_T (*Lf2y)[4];
  real_T (*in1)[10];
  ...
  Lf2y = (real_T (*)[4])mxMalloc(sizeof(real_T [4]));
  ...
  Lf2y_matrix(*in1, *in2, *in3, *in4, *Lf2y);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(*Lf2y);
}

void Lf2y_matrix_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  Lf2y_matrix_xil_terminate();
  Lf2y_matrix_xil_shutdown();
...
void Lf2y_matrix_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_Lf2y_matrix_api.c) */
