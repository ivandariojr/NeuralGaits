...
/* Include files */
#include "_coder_Lf_psw_ub_api.h"
#include "_coder_Lf_psw_ub_mex.h"
...
void Lf_psw_ub_atexit(void)
{
  ...
  Lf_psw_ub_xil_terminate();
  Lf_psw_ub_xil_shutdown();
...
/* End of code generation (_coder_Lf_psw_ub_api.c) */
