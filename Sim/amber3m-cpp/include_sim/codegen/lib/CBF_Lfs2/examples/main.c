...
static void main_CBF_Lfs2(void);
...
static void main_CBF_Lfs2(void)
{
  ...
  /* Initialize function 'CBF_Lfs2' input arguments. */
  ...
  /* Call the entry-point 'CBF_Lfs2'. */
  argInit_10x1_real_T(dv);
  argInit_1x5_real_T(dv1);
  argInit_1x2_real_T(dv2);
  ldes_tmp = CBF_Lfs2(dv, dv1, dv2, ldes_tmp, ldes_tmp, ldes_tmp, ldes_tmp);
}
