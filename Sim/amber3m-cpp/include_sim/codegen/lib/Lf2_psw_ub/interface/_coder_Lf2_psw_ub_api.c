...
/* Include files */
#include "_coder_Lf2_psw_ub_api.h"
#include "_coder_Lf2_psw_ub_mex.h"
...
void Lf2_psw_ub_api(const mxArray *const prhs[5], const mxArray **plhs)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  ub = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[4]), "ub");
  /* Invoke the target function */
  h = Lf2_psw_ub(*in1, h, k, r, ub);
  /* Marshall function outputs */
  *plhs = emlrt_marshallOut(h);
}

void Lf2_psw_ub_atexit(void)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  Lf2_psw_ub_xil_terminate();
  Lf2_psw_ub_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}

void Lf2_psw_ub_initialize(void)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
...
void Lf2_psw_ub_terminate(void)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
...
/* End of code generation (_coder_Lf2_psw_ub_api.c) */
