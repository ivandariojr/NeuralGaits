...
void D_matrix_api(const mxArray * const prhs[1], int32_T nlhs, const mxArray
                  *plhs[1])
{
  real_T (*D)[25];
  real_T (*in1)[5];
  ...
  D = (real_T (*)[25])mxMalloc(sizeof(real_T [25]));
...
void D_matrix_atexit(void)
{
  ...
  D_matrix_xil_terminate();
  D_matrix_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}

void D_matrix_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_D_matrix_api.c) */
