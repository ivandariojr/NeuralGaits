...
void p_hip_api(const mxArray * const prhs[1], int32_T nlhs, const mxArray *plhs
               [1])
{
  real_T (*phip)[2];
  real_T (*in1)[5];
  ...
  phip = (real_T (*)[2])mxMalloc(sizeof(real_T [2]));
  ...
  plhs[0] = emlrt_marshallOut(*phip);
}

void p_hip_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_p_hip_api.c) */
