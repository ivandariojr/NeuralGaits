...
void CBF_Lf2s3_api(const mxArray * const prhs[2], int32_T nlhs, const mxArray
                   *plhs[1])
{
  real_T (*in1)[10];
  real_T xmin;
  ...
  xmin = CBF_Lf2s3(*in1, xmin);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(xmin);
}

void CBF_Lf2s3_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  CBF_Lf2s3_xil_terminate();
  CBF_Lf2s3_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}

void CBF_Lf2s3_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_CBF_Lf2s3_api.c) */
