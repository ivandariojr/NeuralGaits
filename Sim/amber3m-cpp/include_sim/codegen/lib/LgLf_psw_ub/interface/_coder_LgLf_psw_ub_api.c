...
void LgLf_psw_ub_api(const mxArray *const prhs[5], const mxArray **plhs)
{
  ...
  b_LgLf_psw_ub = (real_T(*)[4])mxMalloc(sizeof(real_T[4]));
  ...
  LgLf_psw_ub(*in1, h, k, r, ub, *b_LgLf_psw_ub);
  /* Marshall function outputs */
  *plhs = emlrt_marshallOut(*b_LgLf_psw_ub);
}
...
void LgLf_psw_ub_atexit(void)
{
  ...
  LgLf_psw_ub_xil_terminate();
  LgLf_psw_ub_xil_shutdown();
...
/* End of code generation (_coder_LgLf_psw_ub_api.c) */
