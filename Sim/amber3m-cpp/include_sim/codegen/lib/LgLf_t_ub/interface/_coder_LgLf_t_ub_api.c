...
void LgLf_t_ub_api(const mxArray *const prhs[2], const mxArray **plhs)
{
  ...
  real_T(*in1)[10];
  real_T(*b_LgLf_t_ub)[4];
  real_T ub;
  st.tls = emlrtRootTLSGlobal;
  b_LgLf_t_ub = (real_T(*)[4])mxMalloc(sizeof(real_T[4]));
  /* Marshall function inputs */
  in1 = emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "in1");
  ub = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "ub");
  /* Invoke the target function */
  LgLf_t_ub(*in1, ub, *b_LgLf_t_ub);
  /* Marshall function outputs */
  *plhs = emlrt_marshallOut(*b_LgLf_t_ub);
}
...
void LgLf_t_ub_atexit(void)
{
  ...
  LgLf_t_ub_xil_terminate();
  LgLf_t_ub_xil_shutdown();
...
/* End of code generation (_coder_LgLf_t_ub_api.c) */
