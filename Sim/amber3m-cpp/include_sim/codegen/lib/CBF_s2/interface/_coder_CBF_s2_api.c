...
void CBF_s2_api(const mxArray * const prhs[7], int32_T nlhs, const mxArray *
                plhs[1])
{
  real_T (*in1)[5];
  real_T (*in2)[5];
  ...
  ldes = CBF_s2(*in1, *in2, *in3, ldes, r, m1, a);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(ldes);
}

void CBF_s2_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  CBF_s2_xil_terminate();
  CBF_s2_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}

void CBF_s2_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_CBF_s2_api.c) */
