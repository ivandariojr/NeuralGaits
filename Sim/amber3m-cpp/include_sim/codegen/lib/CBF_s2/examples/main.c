...
static void main_CBF_s2(void)
{
  ...
  /* Initialize function 'CBF_s2' input arguments. */
  ...
  /* Call the entry-point 'CBF_s2'. */
  argInit_5x1_real_T(dv);
  argInit_5x1_real_T(dv1);
  argInit_1x2_real_T(dv2);
  ldes_tmp = CBF_s2(dv, dv1, dv2, ldes_tmp, ldes_tmp, ldes_tmp, ldes_tmp);
}
