...
#include "CBF_ds1edx_terminate.h"
...
static void main_CBF_ds1edx(void);
...
static void main_CBF_ds1edx(void)
{
  ...
  /* Initialize function 'CBF_ds1edx' input arguments. */
  ...
  /* Call the entry-point 'CBF_ds1edx'. */
  argInit_10x1_real_T(dv);
  argInit_1x5_real_T(dv1);
  argInit_1x2_real_T(dv2);
  CBF_ds1edx(dv, dv1, dv2, ldes_tmp, ldes_tmp, ldes_tmp, ldes_tmp, ds1edx);
}
