...
void CBF_ds1edx_api(const mxArray * const prhs[7], int32_T nlhs, const mxArray
                    *plhs[1])
{
  real_T (*ds1edx)[10];
  real_T (*in1)[10];
  ...
  ds1edx = (real_T (*)[10])mxMalloc(sizeof(real_T [10]));
  ...
  CBF_ds1edx(*in1, *in2, *in3, ldes, r, m1, a, *ds1edx);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(*ds1edx);
}

void CBF_ds1edx_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  CBF_ds1edx_xil_terminate();
  CBF_ds1edx_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}

void CBF_ds1edx_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
void CBF_ds1edx_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_CBF_ds1edx_api.c) */
