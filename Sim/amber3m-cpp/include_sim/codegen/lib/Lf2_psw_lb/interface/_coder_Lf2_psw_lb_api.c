...
/* Include files */
#include "_coder_Lf2_psw_lb_api.h"
#include "_coder_Lf2_psw_lb_mex.h"
...
void Lf2_psw_lb_atexit(void)
{
  ...
  Lf2_psw_lb_xil_terminate();
  Lf2_psw_lb_xil_shutdown();
...
/* End of code generation (_coder_Lf2_psw_lb_api.c) */
