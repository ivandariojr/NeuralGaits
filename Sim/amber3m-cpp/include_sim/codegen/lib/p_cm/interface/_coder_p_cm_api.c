...
void p_cm_api(const mxArray * const prhs[1], int32_T nlhs, const mxArray *plhs[1])
{
  real_T (*pcm)[2];
  real_T (*in1)[5];
  ...
  pcm = (real_T (*)[2])mxMalloc(sizeof(real_T [2]));
  ...
  plhs[0] = emlrt_marshallOut(*pcm);
}

void p_cm_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_p_cm_api.c) */
