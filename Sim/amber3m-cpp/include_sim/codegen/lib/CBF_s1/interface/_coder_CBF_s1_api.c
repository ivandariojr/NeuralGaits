...
void CBF_s1_api(const mxArray * const prhs[7], int32_T nlhs, const mxArray *
                plhs[1])
{
  real_T (*in1)[5];
  real_T (*in2)[5];
  ...
  ldes = CBF_s1(*in1, *in2, *in3, ldes, r, m1, a);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(ldes);
}

void CBF_s1_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  CBF_s1_xil_terminate();
  CBF_s1_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}

void CBF_s1_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_CBF_s1_api.c) */
