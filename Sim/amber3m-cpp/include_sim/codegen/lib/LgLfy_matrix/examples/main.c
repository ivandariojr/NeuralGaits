...
#include "LgLfy_matrix_terminate.h"
...
static void main_LgLfy_matrix(void);
...
static void main_LgLfy_matrix(void)
{
  ...
  /* Initialize function 'LgLfy_matrix' input arguments. */
