...
%%
% codegen -config coder.config('lib') dydq_matrix -args {x, c', O', alpha}
% codegen -config coder.config('lib') ddydq_matrix -args {x, c', O', alpha}
% codegen -config coder.config('lib') LgLfhe_matrix -args {q}
% codegen -config coder.config('lib') Lf2he_matrix -args {x}
%%
...
codegen -config cfg psw_lb -args {x,h,k,r,lb}
codegen -config cfg Lf_psw_lb -args {x,h,k,r,lb}
codegen -config cfg Lf2_psw_lb -args {x,h,k,r,lb}
codegen -config cfg LgLf_psw_lb -args {x,h,k,r,lb}
codegen -config cfg psw_ub -args {x,h,k,r,ub}
codegen -config cfg Lf_psw_ub -args {x,h,k,r,ub}
codegen -config cfg Lf2_psw_ub -args {x,h,k,r,ub}
codegen -config cfg LgLf_psw_ub -args {x,h,k,r,ub}
%% 
